          ...
          <div className="flex flex-wrap xl:w-9/12 mx-auto mt-10 lg:items-center md:items-start">
            ...
            <div className="md:w-7/12 w-full px-10">
              <p className="text-lg leading-relaxed">
                I'm a Flutter Developer from Indonesia. Application development with Flutter is different from other
                frameworks because the first time I felt something was different with this framework. Now if people ask
                me what my hobby is, I will answer developing applications with Flutter.
              </p>
